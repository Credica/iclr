...
NON_RND_JOBS_FILE=$ARTIFACT_ROOT/manifests/baseline_non_rnd_machine_2.txt
RND_JOBS_FILE=$ARTIFACT_ROOT/manifests/baseline_rnd_machine_2.txt
...
echo 'PHASE 1/2: non-R&D baselines (46 runs)'
...
echo 'PHASE 2a/2: R&D teachers and rollouts (15 DMC prerequisites)'
bash "$SCRIPT_DIR/run_two_per_gpu_queue.sh" \
...
echo 'PHASE 2b/2: R&D student distillation (6 DMC runs)'
